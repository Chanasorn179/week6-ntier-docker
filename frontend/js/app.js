...
// ============================================
// UI Functions (เหมือนเดิมทั้งหมด)
// ============================================
...
async function renderTasks() {
  ...
  try {
    ...
    todoList.innerHTML =
      '<div class="error-message">Failed to load tasks</div>';
  }
}
...
async function renderStats() {
  ...
  try {
    ...
    statsDiv.innerHTML =
      '<span class="stat-item">❌ Failed to load stats</span>';
  }
}
...
document.addEventListener("DOMContentLoaded", () => {
  console.log("☁️ Task Board - Cloud Version Initialized");
  renderTasks();
  renderStats();
